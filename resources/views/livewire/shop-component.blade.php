        ...
        <div class="row">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                ...
                                <option value="date">За часом</option>
                                <option value="date">За зворотнім часом</option>
                                <option value="price">За зростанням ціни</option>
                                <option value="price-desc">За спаданням ціни</option>
                                <option value="alph">За алфавітом</option>
                                <option value="alph-desc">За зворотнім алфавітом</option>
                            </select>
                        </div>
                                ...
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details',['slug'=>$p->slug]) }}" 
                                            class="product-name"><span>{{$p->name}}</span>
                                        </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget filter-widget brand-widget">
                    <h2 class="widget-title">Вибір виробника</h2>
                    <div class="widget-content">
                        <ul class="list-category">
