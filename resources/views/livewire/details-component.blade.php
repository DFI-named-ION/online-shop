            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-price"><span class="product-price">{{$product->regular_price}} грн</span></div>
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#add_infomation" class="tab-control-item">Додаткова інформація</a>
                            <a href="#review" class="tab-control-item">Відгуки</a>
                        </div>
