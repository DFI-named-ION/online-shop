                        ...
                        <div class="primary-nav-section">
                            <div class="container">
                                <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                                    ...
                                    <li class="menu-item">
                                        <a href="/about" class="link-term mercado-item-title">Про сайт</a>
                                    </li>
                                    <li class="menu-item">
                                    ...
                                    <li class="menu-item">
                                        <a href="/contact-us" class="link-term mercado-item-title">Звернення до нас</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="/news" class="link-term mercado-item-title">Новини</a>
                                    </li>													
                                </ul>
                            </div>
                        </div>
